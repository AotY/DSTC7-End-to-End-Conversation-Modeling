...
class Seq2Seq:
    ...
    def train(self,
        ...
        for epoch in range(epochs):
            ...
            while not self.dataset.all_loaded('train'):
                ...
                encoder_input_data, decoder_input_data, decoder_target_data, _, _ = self.dataset.load_data('train',
    ...
    def evaluate(self, samples_per_load=640):
        ...
        while not self.dataset.all_loaded('test'):
            encoder_input_data, decoder_input_data, decoder_target_data, _, _ = self.dataset.load_data('test',
                                                                                                       samples_per_load)
